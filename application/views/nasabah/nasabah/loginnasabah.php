      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <h1><i class="fa fa-user"></i> FORM LOGIN NASABAH</h1>
          </div>
        </div>
      </div>
    </div>
...
<section class="rooms mt100">
  <div class="container">
    <div class="row room-list fadeIn appear"> 
      <div class="col-md-6">
        <form class="clearfix" role="form" method="post" action="<?=base_url()?>nasabah_control/authnasabah">
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <div class="form-group">
                  <label for="subject" accesskey="S">Nama User Nasabah</label>
                  <input name="namauser" type="text" value="" class="form-control" style="color:black" />
                </div>
                <div class="form-group">
                  <label for="subject" accesskey="S">Password User Nasabah</label>
