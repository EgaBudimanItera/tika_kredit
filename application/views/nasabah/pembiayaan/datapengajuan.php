        ...
        <div class="span12">
          ...
          <div class="widget">
            ...
            <div class="widget-body">
             <div><a href="<?=base_url()?>pembiayaan_control/formtambahpengajuan" class="btn btn-primary">Tambah Pengajuan</a></div>
             <br>
              ...
              <table class="table table-striped table-bordered" id="sample_1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?=$isi->waktu?></td>
                    <td>
                      <a href="<?=base_url()?>pembiayaan_control/hapuspengajuan/<?=$isi->idpembiayaan?>" class="btn btn-warning" onclick="return confirm('yakin akan menghapus data ini?')">Hapus</a>
                    </td>
                  </tr>
                  <?php    
                    }
