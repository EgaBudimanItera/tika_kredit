...
<div id="main-content">
  ...
  <div class="container-fluid">
    ...
    <div id="page" class="dashboard"> 
       <form role="form" method="post" action="<?=base_url()?>pembiayaan_control/aksipengajuan" enctype="multipart/form-data"> 
            ...
            <div class="widget">
              ...
              <div class="widget-body">
                ...
                <div class="control-group primary">
                  ...
                  <div class="controls">
                     <input type="text" class="span6"  readonly value="<?php echo number_format($isipembiayaan->jumlah)?>"  />
                     <input type="hidden" class="span6" id="jumlah" readonly value="<?=$isipembiayaan->jumlah?>" name="jumlah" />
                     <span class="help-inline"></span>
                  </div>
                </div> 
                ...
                <div class="control-group primary">
                  ...
                  <div class="controls">
                     <input type="text" class="span6" readonly value="<?=$isipembiayaan->tglsurvey?>" />
                     <span class="help-inline"></span>
                  </div>
                </div>
                ...
                <div class="control-group primary">
                  ...
                  <div class="controls">
                     <input type="text" class="span6" readonly value="<?=$isipembiayaan->surveyby?>" />
                     <span class="help-inline"></span>
                  </div>
                </div>
                <div class="control-group primary">
                  <label class="control-label" for="inputWarning">Tanggal Bayar Pertama</label>
                  <div class="controls">
                    <div class="input-append" id="ui_date_picker_trigger">
                        <input name="bayarpertama" type="text" class="m-wrap medium" required="" /><span class="add-on"><i class="icon-calendar"></i></span>
                    </div>
                  </div>
                </div> 
                <div class="control-group primary">
                  <label class="control-label" for="inputWarning">Alasan Penolakan</label>
                  <div class="controls">
                     <input type="text" class="span6" name="alasantolak" />
                     <span class="help-inline"></span>
                  </div>
                </div>
                <?php
                  if($isipembiayaan->keputusan=='Proses'){
                ?>
                <div class="form-actions">
                 <input type="submit" name="aksi" value="Setujui Pembiayaan" class="btn btn-primary">
                 <input type="submit" name="aksi" value="Tolak Pembiayaan" class="btn btn-warning">
                </div>
                <?php
                  }
                ?>
