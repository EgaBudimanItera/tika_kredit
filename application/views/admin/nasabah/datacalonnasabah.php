    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="#">Calon Nasabah</a><span class="divider-last">&nbsp;</span></li>
        </ul>
              ...
              <table class="table table-striped table-bordered" id="sample_1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a class="btn btn-primary" href="<?=base_url()?>nasabah_control/detailcalonnasabah/<?=$isi->idnasabah?>">Detail</a></td>
                  </tr>
                  <?php    
                    }
                  ?>
