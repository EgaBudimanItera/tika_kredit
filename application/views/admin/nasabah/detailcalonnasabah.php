    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <ul class="breadcrumb">
          ...
          <li>
            <a href="#">Calon Nasabah</a><span class="divider">&nbsp;</span>
          </li>
          <li>
            <a href="#">Detail Calon Nasabah</a><span class="divider-last">&nbsp;</span>
          </li>
        </ul>
    ...
    <div id="page" class="dashboard">                                                              
          ...
          <div class="span6">
            ...
            <div class="widget">
              <div class="widget-title">
                  <h4><i class="icon-reorder"></i>Identitas Pemohon</h4>
                  <span class="tools">
      ...
      <div class="row-fluid">
        <div class="span12">
            ...
            <div class="widget">
              <div class="widget-title">
                  <h4><i class="icon-reorder"></i>Foto Pemohon</h4>
                  <span class="tools">
                      <a href="javascript:;" class="icon-chevron-down"></a>
                      <a href="javascript:;" class="icon-remove"></a>
                  </span>
              ...
              <div class="widget-body">
                ...
                <table class="table table-striped table-bordered table-advance table-hover">
                  <tr>
                    <td class="span6">Foto 1(Pemohon)</td>
                ...
                <div class="form-actions">
                  <button type="submit" class="btn btn-success">Setujui Permohonan Pendaftaran</button>
